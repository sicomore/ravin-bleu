...
elseif ($_GET["security_code"] != "331ll456cqu60147omt" || $_GET["security_code"] == ("NET2FTP_" . "SECURITY_CODE")) { 
...
$tempdir = dirname(__FILE__) . "/net2ftp_temp_xguju";
...
?>
<form name="ActionForm" action="net2ftp_installer.php?security_code=331ll456cqu60147omt" method="post">
...
<tr><td>Username</td><td><input type="text" name="username" size="25" value="ravinblep"></td></tr>
