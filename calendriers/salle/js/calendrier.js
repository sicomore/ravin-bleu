$(document).ready(function() {
	...
	var calendar = $('#calendrier').fullCalendar({
		...
		locale: 'fr',
		height: 'parent',
		// contentHeight: window.innerWidth < 600 ? 'auto' : 680,
		contentHeight: 'auto',
		...
		eventSources: [{ // ATELIERS
			googleCalendarId: 'ravinbleu.info_4hnjano4jgvjehpr3hq2rtf27g@group.calendar.google.com',
			color: $('#legende.container #atels').css('background-color'),
			textColor: '#ffffff'
		}, { // ATELIER 2
			googleCalendarId: 'ravinbleu.info_9hjvqub440d6r4orc938oqbtls@group.calendar.google.com',
			color: $('#legende.container #atel2').css('background-color'),
			textColor: '#ffffff'
		}, { // ATELIER 3
			googleCalendarId: 'ravinbleu.info_ceafcnvgnba0sm1ur4t0ftuaio@group.calendar.google.com',
			color: $('#legende.container #atel3').css('background-color'),
			textColor: '#ffffff'
		}, { // CHANT
			googleCalendarId: 'ravinbleu.info_dkg2pmfk300scrv47fre3vhdbo@group.calendar.google.com',
			color: $('#legende.container #chant').css('background-color'),
			textColor: '#ffffff'
		}, { // EVENEMENTS
			googleCalendarId: 'ravinbleu.info_kqcpprg9vmpd441n4n80epf2r0@group.calendar.google.com',
			color: $('#legende.container #events').css('background-color'),
			textColor: '#ffffff'
		}, { // GYM DANSE
			googleCalendarId: 'ravinbleu.info_u40n6k3dm3e76eb7pg8d8d03pk@group.calendar.google.com',
			color: $('#legende.container #gym').css('background-color'),
			textColor: '#ffffff'
		}, { // MEDITATION
			googleCalendarId: 'ravinbleu.info_541smvo0gqma6u2apvpj8mhmdg@group.calendar.google.com',
			color: $('#legende.container #medit').css('background-color'),
			textColor: '#ffffff'
		}, { // QI GONG
			googleCalendarId: 'ravinbleu.info_eq9ofouuvgfnmt8ck10d5nemoc@group.calendar.google.com',
			color: $('#legende.container #gong').css('background-color'),
			textColor: '#ffffff'
		}, { // TANGO
			googleCalendarId: 'ravinbleu.info_t6tii6f33c5perak41idq9kqvg@group.calendar.google.com',
			color: $('#legende.container #tango').css('background-color'),
			textColor: '#ffffff'
		}, { // THÉRAPIE INDIVIDUELLE
			googleCalendarId: 'ravinbleu.info_acvkkofc7ms4fdb36r29cqf2ss@group.calendar.google.com',
			color: $('#legende.container #indiv').css('background-color'),
			textColor: '#ffffff'
		}, { // THÉRAPIE GROUPE
			googleCalendarId: 'ravinbleu.info_26kvpv581fgj55dn1vem1j85lk@group.calendar.google.com',
			color: $('#legende.container #groupe').css('background-color'),
			textColor: '#ffffff'
		}, { // YOGA
			googleCalendarId: 'ravinbleu.info_kufu4rovifoq4mhk4pfa6tjav0@group.calendar.google.com',
			color: $('#legende.container #yoga').css('background-color'),
			textColor: '#ffffff'
			// }, {
			// url: 'load.php'
		}],
